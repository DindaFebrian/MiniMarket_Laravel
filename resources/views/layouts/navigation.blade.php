...
<body class="bg-gradient">
    ...
    <nav x-data="{ open: false }" class="bg-gradient-to-r from-pink-500 to-pink-700 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden sm:flex sm:space-x-6 items-center">
                    <a href="#" class="nav-link px-4 py-2 hover:bg-pink-600 rounded-lg transition">
                ...
                <div class="flex items-center sm:hidden">
                    <button @click="open = !open" class="text-white p-2 rounded-md focus:outline-none hover:bg-pink-600 transition">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-gradient-to-r from-pink-500 to-pink-800">
            <div class="space-y-1 py-2">
                <a href="#" class="nav-link block px-4 py-2 hover:bg-pink-600 rounded-lg transition">
                    Dashboard
                </a>
                <a href="#" class="nav-link block px-4 py-2 hover:bg-pink-600 rounded-lg transition">
                    Branches
